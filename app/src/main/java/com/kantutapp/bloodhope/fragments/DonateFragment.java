...
public class DonateFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        causes.add(new Cause("Cause 4","http://www.cheloproject.ca/wp-content/uploads/2017/03/patient-family-member-hospital-bed-1.jpg",""));
        causes.add(new Cause("Cause 5","http://www.cheloproject.ca/wp-content/uploads/2017/03/patient-family-member-hospital-bed-1.jpg",""));
        causes.add(new Cause("Cause 6","http://www.cheloproject.ca/wp-content/uploads/2017/03/patient-family-member-hospital-bed-1.jpg",""));
        causes.add(new Cause("Cause 7","http://www.cheloproject.ca/wp-content/uploads/2017/03/patient-family-member-hospital-bed-1.jpg",""));


        HorizontalInfiniteCycleViewPager infiniteViewPager = mView.findViewById(R.id.card_pager);
        CarrouselPagerAdapter carrouselPagerAdapter = new CarrouselPagerAdapter(getContext(),causes);
        infiniteViewPager.setAdapter(carrouselPagerAdapter);
