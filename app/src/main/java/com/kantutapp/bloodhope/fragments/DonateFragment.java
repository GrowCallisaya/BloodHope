...
public class DonateFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        causes.add(new Cause("Cause 5", "http://www.cheloproject.ca/wp-content/uploads/2017/03/patient-family-member-hospital-bed-1.jpg", "","This is some decription",3,10,"A+","Florida","AZ"));
